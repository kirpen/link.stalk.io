...
var conf = """),format.raw/*47.12*/("""{"""),format.raw/*47.13*/("""
            key: '"""),_display_(Seq[Any](/*48.20*/app/*48.23*/.getUrl())),format.raw/*48.32*/("""',
            id: 'Page Title',
	 ...
	 <script type="text/javascript">
        ...
        $(function()"""),format.raw/*135.21*/("""{"""),format.raw/*135.22*/("""
        	...
        	$('#saveBtn').click(function()"""),format.raw/*140.40*/("""{"""),format.raw/*140.41*/("""
	    		...
	    		, """),format.raw/*144.10*/("""{"""),format.raw/*144.11*/("""'app':'stalk-io','url' : $('#url').val()"""),format.raw/*144.51*/("""}"""),format.raw/*144.52*/("""
